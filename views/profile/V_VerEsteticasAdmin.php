...
<head>
    ...
    <script>
        function updateInputValue() {
            ...
            var selectedValue = selectElement.value; // valor del value
            var customValue = selectElement.options[selectElement.selectedIndex].dataset.customValue; // valor de data-custom-value
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-md">
                            <form action="/Integrador/controllers/C_registrarEstetica.php" method="POST">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <h6>Tipo y precio</h6>
                                                        <select class="form-select" name="tipo_estetica" id="mySelect" onchange="updateInputValue()" required>
                                                            <?php foreach($esteticas_tipos as $data) { ?>
                                                                <option value="<?php echo $data['ID_ETIPOS']; ?>" data-custom-value="<?php echo $data['PRECIO_ETIPOS']; ?>"><?php echo $data['NAME_ETIPOS']; ?> - S/<?php echo $data['PRECIO_ETIPOS']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <h6>Precio del servicio</h6>
                                                        <input type="number" class="form-control" name="precio_servicio" id="myInput" value="" required>
                                                    </div>
                                                </div>
                                                <h3>Cita</h3>
                                                <div class="row">
