        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div>
                        <label for="caja_busqueda_mascotas">Buscar Mascota: </label>
                        <input type="text" name="caja_busqueda_mascotas" id="caja_busqueda_mascotas" class="form-control">
                    </div><br>
                    <div class="table-mascotas-body">
                        <main class="table-mascotas">
