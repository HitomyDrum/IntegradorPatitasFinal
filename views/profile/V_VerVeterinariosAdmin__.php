        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="col-md d-flex justify-content-between align-items-center ms-4">
                                ...
                                <p class="text-muted">Especialidad</p>
                                <p class="text-muted">Celular</p>
                            </div>
                        </div>
                    </div>
                    <?php
                    require_once('../../controllers/C_verVeterinariosAdmin.php');
                    foreach($veterinarios as $data) { ?>
                    <div class="row mb-1">
                        <div class="col-md">
                            <div class="card mb-4 mb-lg-0">
                                <div class="card-body d-flex justify-content-between align-items-center p-3">
                                    <p class="mb-0"><?php echo $data['DNI_VET']; ?></p>
                                    <p class="mb-0"><?php echo $data['NAME_VET']; ?></p>
                                    <p class="mb-0"><?php echo $data['ESPEC_VET']; ?></p>
                                    <p class="mb-0"><?php echo $data['CEL_VET']; ?></p>
                    ...
                    <div class="row">
                        <div class="col-md">
                            <form action="/Integrador/controllers/C_registrarVeterinario.php" method="POST">
                                <button type="button" class="btn btn-patitas" data-bs-toggle="modal" data-bs-target="#exampleModal">Agregar Veterinario</button>
                                <!-- Modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <h6>Nombres</h6>
                                                        <input type="text" class="form-control" name="nombres_vet" required>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <h6>Apellidos</h6>
                                                        <input type="text" class="form-control" name="apellidos_vet" required>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <h6>DNI</h6>
                                                        <input type="text" class="form-control" name="dni_vet" required>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <h6>Especialidad</h6>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <h6>Dirección</h6>
                                                        <input type="text" class="form-control" name="dir_vet" required>
                                                    </div>
                                                </div>
                                            </div>
