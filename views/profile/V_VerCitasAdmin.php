            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <h5 class="card-title">Lista de citas <span class="text-muted fw-normal ms-2">(<?php echo $totalRegistros;?>)</span></h5>
                            </div>
                        </div>
                        <div class="col-md-6">
                                    ...
                                    <table class="table project-list-table table-nowrap align-middle table-borderless">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Comentrario</th>
                                                <th scope="col">Fecha Cita</th>
                                                <th scope="col">Estado</th>
                                                <th scope="col" style="width: 200px;">Acciones</th>
                                            </tr>
                                        </thead>
                                        <tbody id=""> <!-- Id del body en ajax de citas -->
                                        <?php
                                            require_once('../../controllers/C_verCitas.php');
                                            foreach($citas as $data) { 
                                                $fechaHora = new DateTime($data['FECH_CITA']);
                                            ...
                                            <tr>
                                                ...
                                                <td>1</td>
                                                <td><?php echo $data['OBSERV_CITA']; ?></td>
                                                <td><?php echo $data['COMENT_CITA']; ?></td>
                                                <td><?php echo $fecha; ?></td>
                                                <td><span class="badge <?php echo $color; ?> mb-0"><?php echo $estado; ?></span></td>
